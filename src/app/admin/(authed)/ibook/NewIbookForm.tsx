...
import { createIbook } from './actions'

export default function NewIbookForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-3">
      <div>
        <label htmlFor="new-title-fr" className="block text-[10px] uppercase tracking-[0.15em] text-(--color-stone) mb-1">
          Titre FR *
        </label>
        <input
          id="new-title-fr"
      ...
      <div>
        <label htmlFor="new-title-nl" className="block text-[10px] uppercase tracking-[0.15em] text-(--color-stone) mb-1">
          Titel NL
        </label>
        <input
          id="new-title-nl"
