...
export default function FavorisGrid({
  photos,
  labels,
}: {
  photos: PhotoMini[]
    ...
    <>
      <div className="flex items-center justify-between mb-6 gap-3">
        ...
        <button
          type="button"
          onClick={() => {
            if (confirm(labels.clearConfirm)) clear()
          }}
