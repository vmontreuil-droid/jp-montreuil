const dict = {
  ...
  boutique: {
    ...
    relatedSee: 'Voir',
    reviewsSeeAll: 'avis',
    quickRateEyebrow: 'Notation rapide',
    quickRateName: 'Votre prénom',
    quickRateSubmit: 'Envoyer',
    quickRateSending: 'Envoi…',
    quickRateThanks: 'Merci ! Jean-Pierre lit votre avis.',
    quickRateNameRequired: 'Votre prénom, s\'il vous plaît',
    quickRateMore: 'Vous voulez en dire plus ?',
    quickRateMoreLink: 'Avis complet ↓',
    ...
    commande: {
      ...
      reference: 'Référence',
      orderedOn: 'Commandée le',
      pendingAlert: 'Cette commande n\'est pas encore payée.',
      payNow: 'Payer maintenant',
      articles: 'Articles',
      shippingFees: 'Frais de port',
      free: 'gratuit',
      total: 'Total',
      b2bSection: 'Facturation entreprise',
      vatLabel: 'TVA',
      ...
      verifBody: 'Pour consulter cette commande, ajoutez votre e-mail à l\'URL :',
      verifHint: 'Le mail de confirmation contient ce lien complet.',
      // Status labels (mirror van src/lib/shop/orders.ts)
      statusPending: 'En attente paiement',
      statusPaid: 'Payée',
    ...
    facture: {
      back: '← Retour',
      brandTagline: 'Tirages d\'art',
      brandLocation: 'Belgique · jp@montreuil.be',
      ...
      free: 'gratuit',
      total: 'Total',
      vatExempt: 'Petite entreprise soumise au régime de la franchise de TVA — TVA non applicable, art. 56bis du Code de la TVA.',
